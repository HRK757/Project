...
public void signup() {
	    ...
	    driver.findElement(By.xpath("//*[@id=\"userName\"]")).sendKeys("kavya@gmail.com");
	    driver.findElement(By.xpath("//*[@id=\"userPassword\"]")).sendKeys("kavya");
...
@Test (priority=2)	
  public void signin() {
	    ...
	    driver.findElement(By.xpath("//*[@id=\"userName\"]")).sendKeys("hima@gmail.com");
	    driver.findElement(By.xpath("//*[@id=\"userPassword\"]")).sendKeys("hima123");
...
public void approve() {
  ...
  @BeforeMethod
	public void beforeMethod() {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Chromedrive\\chromedriver_win32\\chromedriver.exe");
